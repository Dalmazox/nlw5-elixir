defmodule InmanaWeb.WelcomeController do
  ...
  defp handle_response({:ok, message}, conn), do: render_response(conn, :ok, message)

  defp handle_response({:error, message}, conn), do: render_response(conn, :bad_request, message)
